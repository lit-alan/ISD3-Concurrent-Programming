...
### 2.	Write a method to count the number of elements in an int array that have a specific property (for example, odd integers, even numbers, prime numbers etc.). This method should accept the int array and a lambda expression as arguments. It should return an int (how many elements in the array satisfied the condition specified in the lambda).

### 3.	Write a method to count the number of elements in a String array that have a specific property (for example, how terms in the array begin/end with a particular pattern). This method should accept the String array and a lambda expression as arguments. It should return an int (how many elements in the array satisfied the condition specified in the lambda). 
